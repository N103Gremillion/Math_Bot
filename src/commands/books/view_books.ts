...
import { CommandType, CommandStringType, Command, default_command_builder } from "../command_types";
...
export const view_books_command : Command = {
  ...
  command_builder : view_books_command_builder
}

export function view_books_command_builder(cmd : Command) : SlashCommandBuilder {
